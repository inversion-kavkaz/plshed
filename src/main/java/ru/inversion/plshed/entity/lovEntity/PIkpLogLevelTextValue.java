...
@NamedNativeQuery(
        name = "running",
        query = "SELECT * FROM ikp_text_value where parent_alias ='logLevel'"
)

public class PIkpLogLevelTextValue implements Serializable, lovUtils.LovInterface {
    private static final long serialVersionUID = 11_12_2020_13_11_17l;

    private Long ID;
    private String VALUE;

    public PIkpLogLevelTextValue() {
    }
