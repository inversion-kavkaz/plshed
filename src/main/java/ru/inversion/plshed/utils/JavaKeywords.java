...
public class JavaKeywords {
    ...
    public static StackPane getCodeArea(String sampleCode) {
        ...
        stackPane.getStylesheets().add(JavaKeywords.class.getResource("/styles/java-keywords.css").toExternalForm());
        return stackPane;
    }
    ...
    private static class DefaultContextMenu extends ContextMenu {
         ...
         */
        private void fold() {
            ((CodeArea) getOwnerNode()).selectParagraph();
        }
        ...
        private void unfold() {
            ...
            area.undo();//unfoldParagraphs( area.getCurrentParagraph() );
        }
